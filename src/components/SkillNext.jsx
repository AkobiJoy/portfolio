    ...
    return(
        <div className="group relative flex cursor-pointer">
            <motion.div
                ...
                <Image src='/next.svg' width={100} height={100} alt="logo" className="rounded-full
            ...
            <div className="absolute opacity-0 group-hover:opacity-80 transition duration-300 ease-in-out
             group-hover:bg-white h-16 w-16 md:w-16 md:h-16 xl:w-24 xl:h-24 rounded-full z-0">
                <div className="flex flex-col items-center justify-center h-full">
                    ...
                    <p className="text-xs font-meduim md:text-sm md:font-bold text-neutral-800 opacity-100">Next</p>
                </div>
            </div>
